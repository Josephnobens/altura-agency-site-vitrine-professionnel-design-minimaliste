...
export interface _SERVICE {
  ...
  'addProject' : ActorMethod<[string, string, string, ExternalBlob], undefined>,
  'addService' : ActorMethod<[string, string, string, ExternalBlob], undefined>,
  ...
  'isVisible' : ActorMethod<[Principal], boolean>,
  'removeProject' : ActorMethod<[string], undefined>,
  'setVisibility' : ActorMethod<[boolean], undefined>,
  'submitContactMessage' : ActorMethod<[string, string, string], undefined>,
  'toggleVisibility' : ActorMethod<[Principal], undefined>,
